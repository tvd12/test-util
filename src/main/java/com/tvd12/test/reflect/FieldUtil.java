...
public final class FieldUtil {
	...
	public static <V> V getStaticFieldValue(Class<?> clazz, String fieldName, V defaultValue) {
		...
		try {
			...
			throw new IllegalStateException("can not get value of field: " + fieldName + " on " + clazz, e);
		}
	}
	...
	public static void setStaticFieldValue(Class<?> clazz, String fieldName, Object value) {
		...
		try {
			...
			throw new IllegalStateException("can not set value: " + value + " for field: " + fieldName + " on " + clazz, e);
		}
	}
